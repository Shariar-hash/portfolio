    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            await emailjs.send('service_103pu7h', 'template_ew4f6so', {
                ...
                to_email: 'montasirshariar123@gmail.com'
            });
            ...
            const mailtoLink = `mailto:montasirshariar123@gmail.com?subject=${subject}&body=${body}`;
...
console.log('%cFeel free to reach out: montasirshariar123@gmail.com', 'font-size: 12px; color: #a0a0b0;');
